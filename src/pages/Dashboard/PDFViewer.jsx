...
//or from within Dashboard directory:
import PDFViewer from './PDFViewer';
 
 
// Simple PDF viewer without PDF.js complications
// We'll use a hybrid approach: embed + fallback
const PDFViewer = ({
  ...
  const extractFileInfo = (url) => {
    try {
      ...
      // Try to extract case ID from filename (pattern: #XX-XXX or Case #XX-XXX)
    ...
    <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl shadow-sm">
      ...
      <div className="bg-slate-100 p-6">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          {/* PDF Viewer - Embedded PDF with all pages visible */}
          {pdfLoaded && (
            <div className="bg-slate-50 p-4">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                {/* PDF Embed - This will show all pages in a scrollable view */}
                <embed
              ...
              <div className="mt-4 p-4 bg-white rounded-lg border border-slate-200 text-center">
                <p className="text-sm text-slate-600">
                  Document loaded • {totalPages === 'Multiple' ? 'All pages visible' : `${totalPages} pages`} • Scroll to view all content
                </p>
